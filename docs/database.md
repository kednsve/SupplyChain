...
![department](.\imgs\department.png)
...
![order_items](.\imgs\order_items.png)
...
| ------------- | ------------- | ---- | ---- | -------- | -------- |
| id            | int           | 是   | 是   |          | 产品id   |
| name          | varchar(50)  | 否   | 是   |          | 产品名称 |
| image         | varchar(100)  | 否   | 是   |          | 产品图片 |
...
| unit_price | decimal(10,2) | 否   | 是   | 检查约束 | 单价            |
